...
if sys.platform == "win32":
    ...
    def unregister_context_menu():
        ...
        targets = [
            ...
            r"Directory\Background\shell\KoupreyZipExtractHere",
            r"Directory\Background\shell\KoupreyZipExtractTo",
    ...
    def register_context_menu(compress_label="", extract_label="", open_label="",
